 ...
 */
package com.sqli.b2b.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Yb2bacceleratorFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Yb2bacceleratorFulfilmentProcessConstants.PARENT_PROCESS);
