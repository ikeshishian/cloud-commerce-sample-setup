 ...
 */
package com.sqli.b2b.fulfilmentprocess.test;
...
import com.sqli.b2b.fulfilmentprocess.constants.Yb2bacceleratorFulfilmentProcessConstants;
import com.sqli.b2b.fulfilmentprocess.test.events.TestEventListenerCountingEvents;
...
public class FraudCheckIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * Load bean definition from yb2bacceleratorfulfilmentprocess-spring-test-fraudcheck.xml
	 */
	@BeforeClass
	public static void beforeClass()
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/yb2bacceleratorfulfilmentprocess/test/yb2bacceleratorfulfilmentprocess-spring-test-fraudcheck.xml"));
	...
	protected static final String PARAM_NAME_MIN_PERIOD_WAITING_FOR_CLEANUP_IN_SECONDS = "yb2bacceleratorfulfilmentprocess.fraud.minPeriodWaitingForCleanUpInSeconds";
	protected static final String PARAM_NAME_FRAUD_SCORE_LIMIT = "yb2bacceleratorfulfilmentprocess.fraud.scoreLimit";
	protected static final String PARAM_NAME_FRAUD_SCORE_TOLERANCE = "yb2bacceleratorfulfilmentprocess.fraud.scoreTolerance";
	...
	public void before() throws Exception
	{
		...
		{
			importCsv("/yb2bacceleratorfulfilmentprocess/test/testTicketEssentialData.csv", "utf-8");
		}
		importCsv("/yb2bacceleratorfulfilmentprocess/test/testWarehouses.csv", "utf-8");
	...
	{
		final String processDefinitionName = Yb2bacceleratorFulfilmentProcessConstants.ORDER_PROCESS_NAME;
	...
	protected String submitOrderMock(final OrderModel order)
	{
		final OrderProcessModel businessProcessModel = (OrderProcessModel) businessProcessService.createProcess(
				Yb2bacceleratorFulfilmentProcessConstants.ORDER_PROCESS_NAME + order.getCode() + +System.currentTimeMillis(),
				Yb2bacceleratorFulfilmentProcessConstants.ORDER_PROCESS_NAME);
