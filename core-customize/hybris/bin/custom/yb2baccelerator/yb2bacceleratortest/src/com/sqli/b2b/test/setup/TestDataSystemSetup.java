 ...
 */
package com.sqli.b2b.test.setup;
...
import com.sqli.b2b.test.constants.Yb2bacceleratorTestConstants;
import com.sqli.b2b.test.orders.AcceleratorTestOrderData;
...
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/yb2bacceleratortest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/yb2bacceleratortest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/yb2bacceleratortest/import/cstickets.impex");
			...
			importImpexFile(context, "/yb2bacceleratortest/import/csquotes.impex");
		}
	}
}
